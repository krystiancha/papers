...
photo) only the rendering time is important. For our system it takes \todo{upewnić się}{6 ms} to
render single VGA view. This allows us for simulating the camera with \todo{upewnić się}{167 FPS}. 
